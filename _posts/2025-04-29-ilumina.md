...
<a href="https://app.box.com/s/2g4q0gpnm7re9nq8ylfzn59r7cz33s1k" onclick="countClick()" target="_blank">
  iLumina v2.2 - bRO
</a>
<p>Cliques: <span id="clicks">...</span></p>

<script>
  const namespace = "ilumina-skin";
  const key = "download-clicks";

  function updateCounter() {
    fetch(`https://api.countapi.xyz/get/${namespace}/${key}`)
      .then(res => res.json())
      .then(data => {
        document.getElementById("clicks").innerText = data.value;
      });
  }
